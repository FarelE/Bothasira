...
return await conn.sendMessage(jid, { [`${pase}`]: data, mimetype: mime, ...options }, { quoted })
  ...
  */
  ...
  "url": `https://tiktok.com/@story_m155u`,
  "productImageCount": 1,
  ...
  +"item1.X-ABLabel:Ponsel Iphone\n"
  +"item2.EMAIL;type=INTERNET:AryaGamteng@gmail.com\n"
  +"item2.X-ABLabel:Email\nitem3.URL:https://tiktok.com/@story_m155u\n"
  +"item3.X-ABLabel:Tiktok\n"
  +"item4.ADR:;;Indonesia;;;;\n"
  +"item4.X-ABLabel:Follow tiktok gw\n"
  +"END:VCARD"
//conn.sendMessage(jid,{contacts: {displayName: nama, contacts: [{ vcard }] }, ...opts},{quoted})
  conn.sendMessage(jid, { contextInfo: { externalAdReply: { showAdAttribution: true,
  title: `${botName}`,
  body:`Runtime ${clockString(time)} `,
  previewType:"PHOTO",																											 
  thumbnail: fs.readFileSync('./stik/reply.jpg'),
  sourceUrl:`${fakeUrl}`																																
  }}, contacts: {displayName: nama, contacts: [{ vcard }] }, ...opts},{quoted})
	};
